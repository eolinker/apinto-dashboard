...
import (
	...
	openappModel "github.com/eolinker/apinto-dashboard/model/open-app-model"
	...
	"github.com/eolinker/apinto-dashboard/store/openapp-store"
...
type IExternalApplicationService interface {
	AppList(ctx context.Context, namespaceId int) ([]*openappModel.ExtAppListItem, error)
	AppInfo(ctx context.Context, namespaceId int, uuid string) (*openappModel.ExternalAppInfo, error)
