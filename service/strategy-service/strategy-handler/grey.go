...
type greyHandler struct {
	strategy_service.FormatHandler[strategy_entry.StrategyGreyConfig]
...
func NewStrategyGreyHandler(apintoDriverName string) strategy_service.IStrategyHandler[strategy_entry.StrategyGreyConfig, strategy_entry.StrategyGreyConfig] {
	return &greyHandler{
