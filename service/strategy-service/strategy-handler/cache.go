...
type cacheHandler struct {
	strategy_service.FormatHandler[strategy_entry.StrategyCacheConfig]
...
func NewStrategyCacheHandler(apintoDriverName string) strategy_service.IStrategyHandler[strategy_entry.StrategyCacheConfig, strategy_entry.StrategyCacheConfig] {
	return &cacheHandler{
