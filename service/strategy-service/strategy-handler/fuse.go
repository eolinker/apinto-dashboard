...
type fuseHandler struct {
	strategy_service.FormatHandler[strategy_entry.StrategyFuseConfig]
...
func NewStrategyFuseHandler(apintoDriverName string) strategy_service.IStrategyHandler[strategy_entry.StrategyFuseConfig, strategy_entry.StrategyFuseConfig] {
	return &fuseHandler{
