...
type trafficHandler struct {
	strategy_service.FormatHandler[strategy_entry.StrategyTrafficLimitConfig]
...
func NewStrategyTrafficHandler(apintoDriverName string) strategy_service.IStrategyHandler[strategy_entry.StrategyTrafficLimitConfig, strategy_entry.StrategyTrafficLimitConfig] {
