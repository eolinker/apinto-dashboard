...
import (
	...
	"github.com/eolinker/apinto-dashboard/store/notice-store"
...
type noticeChannelService struct {
	noticeChannelStore   notice_store.INoticeChannelStore
	noticeChannelStat    notice_store.INoticeChannelStatStore
	noticeChannelVersion notice_store.INoticeChannelVersionStore
