...
type IMonitorStatistics interface {
	Statistics(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, groupBy string, wheres []monitor_model.MonWhereItem, limit int) (map[string]monitor_model.MonCommonData, error)
	ProxyStatistics(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, groupBy string, wheres []monitor_model.MonWhereItem, limit int) (map[string]monitor_model.MonCommonData, error)
	Trend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MonCallCountInfo, string, error)
	ProxyTrend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MonCallCountInfo, string, error)
	IPTrend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MonCallCountInfo, error)
	// CircularMap 饼状图数据
	CircularMap(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (request, proxy *monitor_model.CircularDate, err error)
	MessageTrend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MessageTrend, string, error)
	WarnStatistics(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, group string, quotaType monitor_model.QuotaType, wheres []monitor_model.MonWhereItem) (map[string]float64, error)
}
...
func (m *monitorStatistics) Statistics(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, groupBy string, wheres []monitor_model.MonWhereItem, limit int) (map[string]monitor_model.MonCommonData, error) {
	...
	resultMaps := make(map[string]monitor_model.MonCommonData)
	for key, result := range results {
		...
		monCommonData := monitor_model.MonCommonData{
...
func (m *monitorStatistics) ProxyStatistics(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, groupBy string, wheres []monitor_model.MonWhereItem, limit int) (map[string]monitor_model.MonCommonData, error) {
...
func (m *monitorStatistics) CircularMap(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (request, proxy *monitor_model.CircularDate, err error) {
	...
	request = new(monitor_model.CircularDate)
	proxy = new(monitor_model.CircularDate)
...
func (m *monitorStatistics) MessageTrend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MessageTrend, string, error) {
	...
	resultVal := &monitor_model.MessageTrend{
		Dates:       dates,
...
func (m *monitorStatistics) Trend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MonCallCountInfo, string, error) {
	...
	resultVal := &monitor_model.MonCallCountInfo{
		Date:         dates,
...
func (m *monitorStatistics) ProxyTrend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MonCallCountInfo, string, error) {
	newStartTime, every, windowOffset, bucket := m.getTimeIntervelAndBucket(start, end)
...
func (m *monitorStatistics) IPTrend(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, wheres []monitor_model.MonWhereItem) (*monitor_model.MonCallCountInfo, error) {
...
func (m *monitorStatistics) WarnStatistics(ctx context.Context, namespaceId int, partitionId string, start, end time.Time, group string, quotaType monitor_model.QuotaType, wheres []monitor_model.MonWhereItem) (map[string]float64, error) {
	/*
...
func (m *monitorStatistics) calculateWarnStatistics(quotaType monitor_model.QuotaType, data map[string]*monitor_entry.FluxWarnStatistics) map[string]float64 {
	results := make(map[string]float64)

	switch quotaType {
	case monitor_model.QuotaTypeReqFailCount:
		for key, statistic := range data {
			results[key] = float64(statistic.Total - statistic.Success)
		}
	case monitor_model.QuotaTypeReqFailRate:
		for key, statistic := range data {
	...
	case monitor_model.QuotaTypeReqStatus4xx:
		for key, statistic := range data {
			results[key] = float64(statistic.S4xx)
		}
	case monitor_model.QuotaTypeReqStatus5xx:
		for key, statistic := range data {
			results[key] = float64(statistic.S5xx)
		}
	case monitor_model.QuotaTypeProxyFailCount:
		for key, statistic := range data {
			results[key] = float64(statistic.ProxyTotal - statistic.ProxySuccess)
		}
	case monitor_model.QuotaTypeProxyFailRate:
		for key, statistic := range data {
	...
	case monitor_model.QuotaTypeProxyStatus4xx:
		for key, statistic := range data {
			results[key] = float64(statistic.ProxyS4xx)
		}
	case monitor_model.QuotaTypeProxyStatus5xx:
		for key, statistic := range data {
			results[key] = float64(statistic.ProxyS5xx)
		}
	case monitor_model.QuotaTypeReqMessage:
		for key, statistic := range data {
			results[key] = float64(statistic.TotalRequest) / 1024
		}
	case monitor_model.QuotaTypeRespMessage:
		for key, statistic := range data {
...
func (m *monitorStatistics) getOpenApi(dbConfig *monitor_model.MonitorInfluxV2Config) (api.QueryAPI, error) {
...
func (m *monitorStatistics) formatFilter(wheres []monitor_model.MonWhereItem) string {
	filter := ``
	if len(wheres) > 0 {
...
func (m *monitorStatistics) getStatisticsFilterByQuota(quotaType monitor_model.QuotaType) (*monitor_entry.StatisticsFilterConf, error) {
	...
	switch quotaType {
	case monitor_model.QuotaTypeReqFailCount, monitor_model.QuotaTypeReqFailRate:
	...
	case monitor_model.QuotaTypeReqStatus5xx:
		...
		return filterConf, nil
	case monitor_model.QuotaTypeProxyFailCount, monitor_model.QuotaTypeProxyFailRate:
