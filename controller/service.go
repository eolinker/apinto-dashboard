...
func RegisterServiceRouter(router gin.IRouter) {
	...
	router.GET("/services", genAccessHandler(access.ServiceView, access.ServiceEdit), c.getList)
	router.GET("/service", genAccessHandler(access.ServiceView, access.ServiceEdit), c.getInfo)
	router.PUT("/service", genAccessHandler(access.ServiceEdit), logHandler(enum.LogOperateTypeEdit, enum.LogKindService), c.alter)
	router.POST("/service", genAccessHandler(access.ServiceEdit), logHandler(enum.LogOperateTypeCreate, enum.LogKindService), c.create)
	router.DELETE("/service", genAccessHandler(access.ServiceEdit), logHandler(enum.LogOperateTypeDelete, enum.LogKindService), c.del)
	router.GET("/service/enum", c.getEnum)

	router.PUT("/service/:service_name/online", genAccessHandler(access.ServiceEdit), logHandler(enum.LogOperateTypePublish, enum.LogKindService), c.online)
	router.PUT("/service/:service_name/offline", genAccessHandler(access.ServiceEdit), logHandler(enum.LogOperateTypePublish, enum.LogKindService), c.offline)
	router.GET("/service/:service_name/onlines", genAccessHandler(access.ServiceView, access.ServiceEdit), c.getOnlineList)
