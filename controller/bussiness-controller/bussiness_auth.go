...
type bussinessAuthController struct {
	bussinessAuthService bussiness_service.IBussinessAuthService
}
...
func RegisterBussinessAuthRouter(router gin.IRouter) {
	...
	router.GET("/_system/activation/info", controller.GenAccessHandler(access.AuthorizationView, access.AuthorizationEdit), b.acivationInfo)
	router.GET("/_system/run-info", b.getRunInfo)
	router.GET("/_system/mac", b.getMac)
	router.POST("/_system/activation", b.activation)
	router.POST("/_system/reactivation", controller.GenAccessHandler(access.AuthorizationEdit), b.reactivation)
}
...
func formatActivationInfo(info *bussiness_model.ActivationInfo) []*dto.ActivationInfoItem {
