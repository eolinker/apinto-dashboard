...
type strategyController[T any, K any] struct {
	strategyService strategy_service.IStrategyService[T, K]
}

func newStrategyController[T any, K any](strategyService strategy_service.IStrategyService[T, K]) *strategyController[T, K] {
