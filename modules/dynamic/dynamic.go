...
type IDynamicService interface {
	...
	Online(ctx context.Context, namespaceId int, profession string, name string, names []string, updater int, depend ...string) ([]string, []string, error)
	Offline(ctx context.Context, namespaceId int, profession string, name string, names []string, updater int, depend ...string) ([]string, []string, error)
	...
	Create(ctx context.Context, namespaceId int, profession string, skill string, title string, name string, driver string, description string, body string, updater int, depend ...string) error
	Save(ctx context.Context, namespaceId int, profession string, title string, name string, description string, body string, updater int, depend ...string) error
	Delete(ctx context.Context, namespaceId int, profession string, name string, depend ...string) error
