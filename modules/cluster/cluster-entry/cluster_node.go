...
type ClusterNode struct {
	...
	ClusterId   int       `gorm:"type:int(11);size:11;not null;uniqueIndex:cluster;column:cluster;comment:集群ID"`
	Name        string    `gorm:"size:255;not null;column:name;uniqueIndex:cluster;comment:节点名称/Uuid"`
	AdminAddr   string    `gorm:"type:text;default:null;column:admin_addr;comment:管理地址"`
	ServiceAddr string    `gorm:"type:text;not null;column:service_addr;comment:服务地址"`
