...
type ClusterConfig struct {
	...
	Type        string    `gorm:"size:50;default:null;column:type;uniqueIndex:cluster_type"`
	ClusterId   int       `gorm:"type:int(11);size:11;not null;column:cluster;uniqueIndex:cluster_type;comment:集群ID"`
