...
type CommonGroup struct {
	...
	Name        string    `gorm:"size:50;not null;uniqueIndex:name_parentID;column:name;comment:名称"`
	ParentId    int       `gorm:"type:int(11);size:11;not null;uniqueIndex:name_parentID;default:0;column:parent_id;comment:父级目录ID"`
