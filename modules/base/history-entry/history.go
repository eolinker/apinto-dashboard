...
type History struct {
	...
	Kind        HistoryKind `gorm:"size:50;not null;column:kind;comment:kind;index:kind_target"`
	TargetID    int         `gorm:"type:int(11);size:11;not null;column:target;comment:根据kind区分;index:kind_target"`
