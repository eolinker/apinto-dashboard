...
type Version struct {
	...
	Target      int       `gorm:"type:int(11);size:11;not null;index:kind;column:target;comment:根据kind区分是哪个表的ID"`
	Kind        string    `gorm:"size:20;not null;column:kind;index:kind;comment:类型"`
