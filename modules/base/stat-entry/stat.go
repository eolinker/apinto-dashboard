...
type Stat struct {
	...
	Kind    string `gorm:"size:20;not null;column:kind;uniqueIndex:kind_tag;comment:根据kind区分是哪个表的ID"`
	Tag     int    `gorm:"type:int(11);size:11;not null;column:target;uniqueIndex:kind_tag"`
