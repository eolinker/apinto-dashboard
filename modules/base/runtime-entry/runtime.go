...
type Runtime struct {
	...
	ClusterID   int       `gorm:"type:int(11);size:11;not null;column:cluster;uniqueIndex:cluster;comment:集群ID"`
	Kind        string    `gorm:"size:20;not null;index:kind;column:kind;uniqueIndex:cluster;comment:类型"`
	TargetID    int       `gorm:"type:int(11);size:11;default:0;column:target;uniqueIndex:cluster;comment:根据type区分是哪个表的ID"`
