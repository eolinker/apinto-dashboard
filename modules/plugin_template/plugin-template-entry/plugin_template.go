...
type PluginTemplate struct {
	...
	UUID        string    `gorm:"size:36;not null;column:uuid;comment:UUID;uniqueIndex:uuid;" json:"uuid,omitempty"`
	Name        string    `gorm:"size:255;not null;column:name;uniqueIndex:namespace_name;comment:插件模板名称" json:"name,omitempty"`
