...
type ClusterPlugin struct {
	...
	ClusterId   int       `gorm:"type:int(11);size:11;not null;column:cluster;uniqueIndex:cluster_plugin;comment:集群ID" json:"cluster,omitempty"`
	PluginName  string    `gorm:"size:255;not null;column:plugin_name;uniqueIndex:cluster_plugin;comment:插件名称" json:"plugin_name,omitempty"`
	Status      int       `gorm:"type:tinyint(2);not null;column:status;comment:插件状态" json:"status,omitempty"` //1禁用 2启用 3全局启用
	Config      string    `gorm:"type:text;not null;column:config;comment:插件配置信息" json:"config,omitempty"`
