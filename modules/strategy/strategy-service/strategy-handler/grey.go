...
type greyHandler struct {
	strategy.FormatHandler[strategy_entry.StrategyGreyConfig]
...
func NewStrategyGreyHandler(apintoDriverName string) strategy.IStrategyHandler[strategy_entry.StrategyGreyConfig, strategy_entry.StrategyGreyConfig] {
	return &greyHandler{
