...
type Variables struct {
	...
	Namespace  int       `gorm:"type:int(11);size:11;not null;column:namespace;uniqueIndex:namespace;comment:工作空间"`
	Key        string    `gorm:"size:255;not null;column:key;uniqueIndex:namespace;comment:key"`
	Desc       string    `gorm:"size:255;not null;column:desc;comment:描述"`
	Operator   int       `gorm:"type:int(11);not null;size:11;column:operator;comment:更新人/操作人"`
