...
type Variables struct {
	...
	Namespace  int       `gorm:"type:int(11);size:11;not null;column:namespace;uniqueIndex:namespace_key_index;comment:工作空间"`
	Key        string    `gorm:"size:255;not null;column:key;uniqueIndex:namespace_key_index;comment:key"`
