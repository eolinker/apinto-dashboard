...
type ClusterVariable struct {
	...
	ClusterId   int       `gorm:"type:int(11);size:11;not null;column:cluster;uniqueIndex:cluster;comment:集群ID" json:"cluster_id"`
	VariableId  int       `gorm:"type:int(11);size:11;not null;column:variable;uniqueIndex:cluster;comment:全局环境变量ID" json:"variable_id"`
	...
	Operator    int       `gorm:"type:int(11);size:11;not null;column:operator;comment:操作人"` //操作人
