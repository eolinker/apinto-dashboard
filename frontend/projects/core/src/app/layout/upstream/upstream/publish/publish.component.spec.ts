...
import { UpstreamPublishComponent } from './publish.component'
...
describe('UpstreamPublishComponent test', () => {
  let component: UpstreamPublishComponent
  let fixture: ComponentFixture<UpstreamPublishComponent>
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(UpstreamPublishComponent)
  ...
  it('click table btns', () => {
    ...
    const item = { key: 'test' }
    component.clustersTableBody[5].btns[0].click(item)
    expect(spyUpdateOrOnline).toHaveBeenCalledTimes(1)
    expect(spyOffline).toHaveBeenCalledTimes(0)

    component.clustersTableBody[5].btns[1].click(item)
    expect(spyUpdateOrOnline).toHaveBeenCalledTimes(1)
