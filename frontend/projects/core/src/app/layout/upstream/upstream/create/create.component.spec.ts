...
describe('UpstreamCreateComponent test as editPage is false', () => {
  ...
  it('getDiscovery with success return', () => {
    ...
    component.createUpstreamForm.discovery_name = 'test1'
    ...
    component.createUpstreamForm.discovery_name = 'test2'
    component.getDiscovery()
    fixture.detectChanges()
  ...
  it('changeBasedata', fakeAsync(() => {
    ...
    component.createUpstreamForm.discovery_name = 'test'
    ...
    const mockValue2 = {
      ...
      data: {
        service: {
          ...
          desc: 'description',
          config: {
            static_conf: [{ addr: 'addr1', weight: 'weight1' }]
          }
        }
      }
    }
  ...
  it('getDataFromDynamicComponent when discovery_name is static', () => {
    const testVal1 = {
    ...
    testVal1.config.addrs_variable = 'test'
    expect(component.canBeSave).toStrictEqual(false)
    component.getDataFromDynamicComponent(testVal1)
    fixture.detectChanges()
    ...
    testVal1.config.use_variable = false
    expect(component.canBeSave).toStrictEqual(true)
    component.getDataFromDynamicComponent(testVal1)
    fixture.detectChanges()
    ...
    testVal1.config.static_conf = [{ addr: 'testAddr', weight: 0 }]
    ...
    testVal1.config.static_conf = [{ addr: '', weight: 3 }]
    ...
    testVal1.config.static_conf = [{ addr: 'testAddr', weight: 3 }]
  ...
  it('getDataFromDynamicComponent when discovery_name is static', () => {
    ...
    testVal2.config.service_name = 'test'
