...
describe('ServiceDiscoveryListComponent test', () => {
  ...
  it('getServicesList with success return', () => {
    ...
    const spyService = jest.spyOn(httpCommonService, 'get').mockReturnValue(of({ code: 0, data: { discoveries: [{ name: 'test1', driver: 'static', desc: 'description', update_time: 'time', is_delete: 'false' }, { name: 'test2', driver: 'static', desc: 'description', update_time: 'time', is_delete: 'false' }] } }))
