...
import { ServiceDiscoveryPublishComponent } from './publish.component'
...
describe('ServiceDiscoveryMessageComponent test', () => {
  let component: ServiceDiscoveryPublishComponent
  let fixture: ComponentFixture<ServiceDiscoveryPublishComponent>
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ServiceDiscoveryPublishComponent)
