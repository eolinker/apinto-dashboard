...
export class ApiManagementComponent implements OnInit {
  ...
  addGroupModal = (uuid?:any) => {
    ...
    this.groupModal = this.modalService.create({
      ...
      nzComponentParams: { uuid: uuid, type: 'add', closeModal: this.closeModal , showUuid:false},
      nzClosable: true,
      nzCancelText: '取消',
      nzOkText: '确定',
  ...
  editGroupModal = (uuid:string, name?:string) => {
    this.groupModal = this.modalService.create({
      ...
      nzContent: ApiManagementEditGroupComponent,
      nzWidth: MODAL_SMALL_SIZE,
      nzComponentParams: { groupName: name, uuid: uuid, type: 'edit', closeModal: this.closeModal , showUuid:true },
      nzClosable: true,
      nzOkText: '确定',
      nzCancelText: '取消',
      nzOnOk: (component:ApiManagementEditGroupComponent) => {
