...
describe('ApiCreateComponent test as editPage is false', () => {
  ...
  it('click table btns', () => {
    ...
    component.createApiForm.match = [
      { position: 'test1', match_type: 'test1', key: 'test1', pattern: 'test1' },
      { position: 'test2', match_type: 'test2', key: 'test2', pattern: 'test2' },
      { position: 'test3', match_type: 'test3', key: 'test3', pattern: 'test3' }
    ]
    component.matchTableBody[4].btns[1].click({ position: 'test2', match_type: 'test2', key: 'test2', pattern: 'test2' })
    fixture.detectChanges()
    component.createApiForm.match = [
      { position: 'test1', match_type: 'test1', key: 'test1', pattern: 'test1' },
      { position: 'test3', match_type: 'test3', key: 'test3', pattern: 'test3' }
    ...
    component.createApiForm.proxy_header = [
      { opt_type: 'test1', key: 'test1', value: 'test1' },
      { opt_type: 'test2', key: 'test2', value: 'test2' },
      { opt_type: 'test3', key: 'test3', value: 'test3' }
    ]
    component.proxyHeaderTableBody[3].btns[1].click({ opt_type: 'test3', key: 'test3', value: 'test3' })
    fixture.detectChanges()
    component.createApiForm.proxy_header = [
      { opt_type: 'test1', key: 'test1', value: 'test1' },
      { opt_type: 'test2', key: 'test2', value: 'test2' }
  ...
  it('getApiMessage with success return (method is null)', () => {
    ...
    const spyService = jest.spyOn(httpCommonService, 'get').mockReturnValue(of({ code: 0, data: { api: { group_uuid: '123456', match: [], proxy_header: [] } } }))
  ...
  it('getApiMessage with success return (method is null)', () => {
    const httpCommonService = fixture.debugElement.injector.get(ApiService)
    const spyService = jest.spyOn(httpCommonService, 'get').mockReturnValue(of({ code: 0, data: { api: { group_uuid: 123456, match: [], proxy_header: [], method: ['PUT', 'DELETE'] } } }))
    const isget = httpCommonService.get('') !== null
    // @ts-ignore
    const spyMessage = jest.spyOn(component.message, 'error')
    const spyUpdateAllChecked = jest.spyOn(component, 'updateAllChecked')
  ...
  it('getApiMessage with fail return', () => {
    ...
    expect(spyService).toHaveBeenCalledTimes(1)
    expect(isget).toStrictEqual(true)
    expect(component.createApiForm.group_uuid).toStrictEqual([])
  ...
  it('getHeaderList with success return', () => {
    ...
    component.createApiForm.group_uuid = ['1']
    fixture.detectChanges()
  ...
  it('saveApi with success return', () => {
    ...
    component.createApiForm = {
      ...
      timeout: 100,
      proxy_header: [{
        key: '123', value: '123', opt_type: '123'
      }],
      match: [{
        position: '123', match_type: '123', key: '123', pattern: '123'
      }]
    }
  ...
  it('requestPathChange test', fakeAsync(() => {
    component.createApiForm.proxy_path = ''
    component.createApiForm.request_path = 'test'
    component.requestPathChange()
    fixture.detectChanges()
    expect(component.createApiForm.proxy_path).toStrictEqual('test')

    component.createApiForm.request_path = 'test2'
    component.requestPathChange()
    fixture.detectChanges()
    expect(component.createApiForm.proxy_path).toStrictEqual('test')
  }))
