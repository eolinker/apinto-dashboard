...
describe('FuseCreateComponent test as editPage is false', () => {
  ...
  it('##getStrategyMessage with success return (with null response)', () => {
    ...
    expect(component.responseForm.controls['contentType'].value).toStrictEqual(
      'application/json'
    )
    ...
    const mockValue2: any = {
      ...
      data: {
        strategy: {
          ...
          config: {
            metric: '{service}',
            fuseCondition: { statusCodes: [100, 200], count: 3 },
            fuseTime: { time: 5, maxTime: 5 },
            recoverCondition: { statusCodes: [300, 400], count: 3 },
            response: {
              statusCode: '',
              contentType: '',
              charset: '',
  ...
  it('## saveStrategy with success return', () => {
    ...
    component.createStrategyForm.config.fuseCondition.statusCodes = [110, 112]
    component.createStrategyForm.config.recoverCondition.statusCodes = [1]
    ...
    component.responseForm.controls['statusCode'].setValue(2)
    component.responseForm.controls['contentType'].setValue('application/json')
    ...
    component.createStrategyForm.config.fuseCondition.statusCodes = [110, 112]
    component.createStrategyForm.config.recoverCondition.statusCodes = [100]
    component.validateForm.controls['name'].setValue('test')
    component.validateForm.controls['priority'].setValue(222)
    component.validateForm.controls['configFuseCount'].setValue(2)
    component.validateForm.controls['configFuseTime'].setValue(2)
    ...
    component.validateForm.controls['configFuseMaxTime'].setValue(2)
    component.validateForm.controls['configRecoverCount'].setValue(2)
    component.responseForm.controls['statusCode'].setValue(null)
    component.responseForm.controls['contentType'].setValue('application/json')
    component.responseForm.controls['charset'].setValue('UTF-8')
    component.responseForm.controls['header'].setValue('')
    component.responseForm.controls['body'].setValue('')
    ...
    component.validateForm.controls['configFuseMaxTime'].setValue(2)
    component.validateForm.controls['configRecoverCount'].setValue(2)
    component.responseForm.controls['statusCode'].setValue(2002)
    component.responseForm.controls['contentType'].setValue('application/json')
    component.responseForm.controls['charset'].setValue('UTF-8')
    component.responseForm.controls['header'].setValue('')
    component.responseForm.controls['body'].setValue('')
