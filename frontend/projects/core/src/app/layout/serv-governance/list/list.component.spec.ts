...
describe('ListComponent test', () => {
  ...
  it('##getPublishList with success return and all data', () => {
    ...
    expect(component.validateForm.controls['versionName'].value).toStrictEqual(
      'test1'
    )
  ...
  it('##openDrawer and reset validateForm', () => {
    ...
    component.validateForm.controls['versionName'].setValue('test2')
  ...
  it('##publish with success return', () => {
    ...
    const spyOnControlVerMarkAsDirty = jest.spyOn(
      component.validateForm.controls['versionName'],
      'markAsDirty'
    )
    component.publish()
    fixture.detectChanges()
    ...
    // 表单验证成功 未返回isPublish
    component.validateForm.controls['versionName'].setValue('test')
    ...
    // 表单验证失败 返回isPublish
    component.validateForm.controls['versionName'].setValue('')
