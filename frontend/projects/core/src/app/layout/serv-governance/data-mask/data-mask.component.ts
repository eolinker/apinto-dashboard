...
export class DataMaskComponent {
  constructor (private router:Router) {
    if (this.router.url.split('?')[0] === '/serv-governance/data-mask') {
      this.router.navigate(['/', 'serv-governance', 'data-mask', 'group'])
    }
  }
