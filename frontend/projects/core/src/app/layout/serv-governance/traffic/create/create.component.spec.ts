...
describe('TrafficCreateComponent test as editPage is false', () => {
  ...
  it('##getStrategyMessage with success return (with null response)', () => {
    ...
    expect(component.responseForm.controls['content_type'].value).toStrictEqual('application/json')
  ...
  it('## saveStrategy with success return', () => {
    ...
    component.responseForm.controls['status_code'].setValue('')
    ...
    component.responseForm.controls['status_code'].setValue('201')
