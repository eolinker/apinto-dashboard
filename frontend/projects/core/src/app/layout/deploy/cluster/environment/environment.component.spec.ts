...
describe('DeployClusterEnvironmentComponent test', () => {
  ...
  it('save with success', () => {
    ...
    component.updateConfigsList = [{ key: 'c1', value: 'default_value', variable_id: 0, publish: 'test', status: 'test', desc: 'test', operator: 'test', update_time: 'test', create_time: 'test', id: 0, checked: true }, { key: 'c2', value: 'default_value', variable_id: 0, publish: 'test', id: 0, status: 'test', desc: 'test', operator: 'test', update_time: 'test', create_time: 'test', checked: true }, { key: 'x3', value: 'default_value', variable_id: 0, publish: 'test', status: 'test', desc: 'test', operator: 'test', update_time: 'test', create_time: 'test', id: 0, checked: true }]
