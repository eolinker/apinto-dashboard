...
describe('ApplicationAuthenticationComponent test', () => {
  ...
  it('getAuthMessage with success return (expire_time = 0  & label != {})', () => {
    const val1:any = {
      code: 0,
      data: {
        auth: {
          ...
          position: 'header',
          token_name: '',
          update_time: '2022-08-29 06:58:23',
  ...
  it('getAuthMessage with success return ( expire_time != 0 & config = {})', () => {
    ...
    const val2 = {
      ...
      data: {
        auth: {
          ...
          driver: 'basic',
          expire_time: 1661961599,
          operator: '',
          position: 'header',
          token_name: '1',
          update_time: '2022-08-29 07:16:48',
          is_transparent: false,
          config: {
          }
        }
    ...
    const res2 = {
      ...
      driver: 'basic',
      expire_time: 1661961599,
      expire_time_date: new Date(1661961599000),
      operator: '',
      position: 'header',
      token_name: '1',
      update_time: '2022-08-29 07:16:48',
        ...
        auths: [
          {
            ...
            expire_time: 0,
            operator: '',
            update_time: '2022-08-29 14:31:44',
            rule_info: 'apikey-',
            is_transparent: true
          },
          {
            ...
            expire_time: 0,
            operator: '',
            update_time: '2022-08-30 11:07:26',
            rule_info: 'basic-',
            is_transparent: false
          },
          {
            ...
            expire_time: 0,
            operator: '',
            update_time: '2022-08-31 14:26:53',
            rule_info: 'basic-',
            is_transparent: true
          },
          {
            ...
            info: 'jwt-1',
            driver: 'jwt',
            expire_time: 1662652799,
            operator: '',
            update_time: '2022-08-31 14:27:01',
            rule_info: 'jwt-',
            is_transparent: false
          }
        ]
    ...
    expect(component.authenticationList).toStrictEqual(
      [
        ...
        },
        {
          ...
          info: 'jwt-1',
          driver: 'Jwt',
          expire_time: '2022-09-08 23:59:59',
          operator: '',
          update_time: '2022-08-31 14:27:01',
          rule_info: 'jwt-',
          is_transparent: '否'
  ...
  it('getDataFromDynamicComponent when driver is basic', () => {
    let val1 = { driver: 'basic', config: { user_name: '', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)

    val1 = { driver: 'basic', config: { user_name: '1', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)

    val1 = { driver: 'basic', config: { user_name: '1', password: '1' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
  ...
  it('getDataFromDynamicComponent when driver is apikey', () => {
    let val1:any = { driver: 'apikey', config: { user_name: '', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)
  ...
  it('getDataFromDynamicComponent when driver is aksk', () => {
    let val1:any = { driver: 'aksk', config: { user_name: '', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)
  ...
  it('getDataFromDynamicComponent when driver is jwt', () => {
    let val1:any = { driver: 'jwt', config: { user_name: '', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)
    ...
    val1 = { driver: 'jwt', config: { algorithm: 'HS123', user_name: '', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)
    ...
    val1 = { driver: 'jwt', config: { algorithm: '1ES2', user_name: '', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)
    ...
    val1 = { driver: 'jwt', config: { algorithm: 'ES123', iss: '1', public_key: '1' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(true)

    val1 = { driver: 'jwt', config: { algorithm: '123RS', user_name: '', password: '' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(false)
    ...
    val1 = { driver: 'jwt', config: { algorithm: 'RS123', iss: '1', public_key: '1' } }
    component.canBeSave = false
    component.getDataFromDynamicComponent(val1)
    fixture.detectChanges()
    expect(component.canBeSave).toStrictEqual(true)
  ...
  it('saveAuth with fail return', () => {
    ...
    component.createAuthForm.expire_time_date = new Date()
    component.editAuth = false
    component.saveAuth()
    fixture.detectChanges()
    expect(component.createAuthForm.expire_time).not.toStrictEqual(0)
    expect(spyServicePost).toHaveBeenCalledTimes(2)
