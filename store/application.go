...
type IApplicationStore interface {
	IBaseStore[application_entry.Application]
...
type applicationStore struct {
	*BaseStore[application_entry.Application]
}
...
func newApplicationStore(db IDB) IApplicationStore {
	return &applicationStore{BaseStore: CreateStore[application_entry.Application](db)}
}
