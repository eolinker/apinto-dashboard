...
type IClusterVariableStore interface {
	IBaseStore[variable_entry.ClusterVariable]
...
type clusterVariableStore struct {
	*BaseStore[variable_entry.ClusterVariable]
}

func newClusterVariableStore(db IDB) IClusterVariableStore {
	return &clusterVariableStore{BaseStore: CreateStore[variable_entry.ClusterVariable](db)}
}
