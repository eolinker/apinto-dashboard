...
type IExternalApplicationStore interface {
	store.IBaseStore[open_app_entry.ExternalApplication]
...
type externalApplicationStore struct {
	*store.BaseStore[open_app_entry.ExternalApplication]
}
...
func newExternalApplicationStore(db store.IDB) IExternalApplicationStore {
	return &externalApplicationStore{BaseStore: store.CreateStore[open_app_entry.ExternalApplication](db)}
}
