...
func (m *MockIService) GetServiceInfo(ctx context.Context, namespaceID int, serviceName string) (*model.ServiceInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServiceInfo", ctx, namespaceID, serviceName)
	ret0, _ := ret[0].(*model.ServiceInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIService) GetServiceList(ctx context.Context, namespaceID int, searchName string, pageNum, pageSize int) ([]*model.ServiceListItem, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetServiceList", ctx, namespaceID, searchName, pageNum, pageSize)
	ret0, _ := ret[0].([]*model.ServiceListItem)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(error)
...
func (m *MockIService) GetServiceListAll(ctx context.Context, namespaceID int) ([]*model.ServiceListItem, error) {
	m.ctrl.T.Helper()
...
func (m *MockIService) GetServiceListByNames(ctx context.Context, namespaceID int, names []string) ([]*model.ServiceListItem, error) {
	m.ctrl.T.Helper()
...
func (m *MockIService) OnlineList(ctx context.Context, namespaceId int, serviceName string) ([]*model.ServiceOnline, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OnlineList", ctx, namespaceId, serviceName)
	ret0, _ := ret[0].([]*model.ServiceOnline)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
