...
func (m *MockIAPIService) BatchOffline(ctx context.Context, namespaceId, operator int, apiUUIDs, clusterNames []string) ([]*model.BatchListItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BatchOffline", ctx, namespaceId, operator, apiUUIDs, clusterNames)
	ret0, _ := ret[0].([]*model.BatchListItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIAPIService) BatchOnline(ctx context.Context, namespaceId, operator int, onlineToken string) ([]*model.BatchListItem, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAPIService) BatchOnlineCheck(ctx context.Context, namespaceId, operator int, apiUUIDs, clusterNames []string) ([]*model.BatchOnlineCheckListItem, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BatchOnlineCheck", ctx, namespaceId, operator, apiUUIDs, clusterNames)
	ret0, _ := ret[0].([]*model.BatchOnlineCheckListItem)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
...
func (m *MockIAPIService) GetAPIInfo(ctx context.Context, namespaceID int, uuid string) (*model.APIInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAPIInfo", ctx, namespaceID, uuid)
	ret0, _ := ret[0].(*model.APIInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIAPIService) GetAPIInfoAll(ctx context.Context, namespaceID int) ([]*model.APIInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAPIService) GetAPIInfoByGroupUUID(ctx context.Context, namespaceID int, groupUUID string) ([]*model.APIInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAPIService) GetAPIInfoByUUIDS(ctx context.Context, namespaceID int, uuids []string) ([]*model.APIInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAPIService) GetAPIList(ctx context.Context, namespaceID int, groupUUID, searchName string, searchSources []string, pageNum, pageSize int) ([]*model.APIListItem, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAPIList", ctx, namespaceID, groupUUID, searchName, searchSources, pageNum, pageSize)
	ret0, _ := ret[0].([]*model.APIListItem)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockIAPIService) GetAPIListByServiceName(ctx context.Context, namespaceId int, serviceName []string) ([]*model.APIInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAPIService) GetAPIListItemAll(ctx context.Context, namespaceID int) ([]*model.APIListItem, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAPIService) GetAPIListItemByUUIDS(ctx context.Context, namespaceID int, uuids []string) ([]*model.APIListItem, error) {
	m.ctrl.T.Helper()
...
func (m *MockIAPIService) GetAPIVersionInfo(ctx context.Context, namespaceID int, uuid string) (*model.APIVersionInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAPIVersionInfo", ctx, namespaceID, uuid)
	ret0, _ := ret[0].(*model.APIVersionInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIAPIService) GetImportCheckList(ctx context.Context, namespaceId int, fileData []byte, groupID, serviceName, requestPrefix string) ([]*model.ImportAPIListItem, string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetImportCheckList", ctx, namespaceId, fileData, groupID, serviceName, requestPrefix)
	ret0, _ := ret[0].([]*model.ImportAPIListItem)
	ret1, _ := ret[1].(string)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
}
...
func (m *MockIAPIService) GetLatestAPIVersion(ctx context.Context, apiId int) (*entry.APIVersion, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLatestAPIVersion", ctx, apiId)
	ret0, _ := ret[0].(*entry.APIVersion)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIAPIService) GetSource(ctx context.Context) ([]*model.SourceListItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetSource", ctx)
	ret0, _ := ret[0].([]*model.SourceListItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIAPIService) OnlineList(ctx context.Context, namespaceId int, uuid string) ([]*model.APIOnlineListItem, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OnlineList", ctx, namespaceId, uuid)
	ret0, _ := ret[0].([]*model.APIOnlineListItem)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
